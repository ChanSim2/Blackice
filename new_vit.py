...
PATH = ''
test_dataset = data_manage.CustomDataset(PATH + '/home/MMI22simchan/Mopticon/22_21_test_onetenth.csv', PATH,mode='test')
train_dataset = data_manage.CustomDataset(PATH + '/home/MMI22simchan/Mopticon/22_21_trainset_onetenth.csv', PATH,mode='train')
...
def train(epochs):
    ...
    for epoch in range(epochs):
        ...
        if epoch in [50,60,70,80,90,100]:
            torch.save(model.state_dict(), 'Mopticon/cp220520_temporal/checkpoint{}.pth'.format(epoch))
