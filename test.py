...
#model.load_state_dict(torch.load("/home/MMI22jonguk/Mopticon/22_21_cp_defaultarch/checkpoint39_acc:0.933.pth"))
model.load_state_dict(torch.load("/home/MMI22simchan/Mopticon/cp220520_best/checkpoint12_acc:0.819.pth"))
...
testloader = DataLoader(test_dataset, batch_size=batch, shuffle=False, num_workers=1)
...
with torch.no_grad():
    ...
    for i,data in enumerate(testloader,1):
        ...
        #    sm = sm.numpy()
        #    #print(type(label), type(output_label))
        #    # count sample with class
        #    count_cls[int(label)] += 1
