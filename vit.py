...
PATH = ''
test_dataset = data_manage.CustomDataset(PATH + '/home/MMI22simchan/Mopticon/22_21_test_300.csv', PATH,mode='test')
train_dataset = data_manage.CustomDataset(PATH + '/home/MMI22simchan/Mopticon/22_21_trainset_300.csv', PATH,mode='train')
...
def train(epochs):
    ...
    x_sam_num=0
    model = coatnet_2()
    model.load_state_dict(torch.load("/home/MMI22simchan/Mopticon/cp220519_best/checkpoint23_acc:0.780.pth"))
    ...
    for epoch in range(epochs):
        ...
        acc_list.append(acc)
        if best_score<=acc:
            torch.save(model.state_dict(), '/home/MMI22simchan/Mopticon/cp220520_best/checkpoint{}_acc:{:.3f}.pth'.format(epoch,acc))
            best_score = acc
        if epoch in [50,60,70,80,90,100]:
            torch.save(model.state_dict(), '/home/MMI22simchan/Mopticon/cp220520_temporal/checkpoint{}.pth'.format(epoch))
